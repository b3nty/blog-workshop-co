...
// constructor
    ...
    function rise_home_news() {
		...
		$widget_ops = array('classname' => 'rise_home_news_widget', 'description' => esc_html__( 'Show your blog posts on your home page.', 'rise') );

        parent::__construct(false, $name = esc_html__('MT - Home Posts', 'rise'), $widget_ops);
	...
	<p><label for="<?php echo sanitize_text_field( $this->get_field_id( 'category' )); ?>"><?php esc_html_e( 'Enter the slug for your category or leave empty to show posts from all categories.', 'rise' ); ?></label>
    ...
    <p><label for="<?php echo sanitize_text_field( $this->get_field_id( 'number' )); ?>"><?php esc_html_e( 'Enter the number of posts to display.', 'rise' ); ?></label>
    ...
    <p><label for="<?php echo sanitize_text_field( $this->get_field_id( 'columnset' )); ?>"><?php esc_html_e( 'Enter the number of columns.', 'rise' ); ?></label>
    ...
    <p><label for="<?php echo sanitize_text_field( $this->get_field_id('see_all_text')); ?>"><?php esc_html_e('Button Text. Default is set to See All.', 'rise'); ?></label>
