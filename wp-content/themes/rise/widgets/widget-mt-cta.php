...
// constructor
    ...
    function rise_action() {
		...
		$widget_ops = array('classname' => 'rise_action_widget', 'description' => esc_html__( 'Create a call-to-action for a home page widget area.', 'rise') );

        parent::__construct(false, $name = esc_html__('MT - Call-to-Action', 'rise'), $widget_ops);  
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('action_text')); ?>"><?php esc_html_e('Enter your call to action.', 'rise'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('action_btn_link')); ?>"><?php esc_html_e('Link for the button', 'rise'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('action_btn_text')); ?>"><?php esc_html_e('Title for the button', 'rise'); ?></label>
